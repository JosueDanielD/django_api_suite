...
SECRET_KEY = 'django-insecure-vpnrkr-5mam7la1f3ujx7i+(5(y*4v1ik8wt*ne6s8(tr8a^nl'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Usar Path en lugar de os.path.join
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Usar Path en lugar de os.path.join
]
